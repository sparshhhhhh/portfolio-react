...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_izam7kk', 'template_so0h8c9', form.current, 'P0kCy889XGCmnCNcq')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">dagarsparsh2002@gmail.com</span>
                        
                        <a href="mailto:dagarsparsh2002@gmail.com" className="contact__button">
